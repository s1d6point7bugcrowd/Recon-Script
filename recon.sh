...
function run_nuclei() {
    local target_file=$1
    local nuclei_cmd="nuclei -rl $RATE_LIMIT -ss template-spray -retries 3 -c 2 -timeout 5 -et /home/kali/nuclei-templates/dns/ -H \"$CUSTOM_HEADER\" $SEVERITY_FLAG $CLOUD_UPLOAD_FLAG $DEBUG_FLAG"
